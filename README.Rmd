...
The goal of mmdb is to provide a set of data structures (S4 classes) and tools to be able to create and a lightweight database for macroeconomic modelling.
